                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if ($query['name'] == 'admin' || $query['name'] == 'Admin') readonly  @endif
                                    />
                                ...
                                <div class="d-flex flex-wrap">
                                    @foreach ($roles as $value)
                                        <div class="form-check mt-1 ml-3">
                                            <input class="form-check-input roles" type="checkbox" id="{{ $value->id }}" name="roles[]"
                                                value="{{ $value->id }}"
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                <th scope="col" class="align-middle text-center">
                                                    <input type="checkbox" id="is_view" name="is_create" onclick='select_is_view()' />
                                                </th>
                                                <th scope="col" class="align-middle text-center">
...
@section('page-script')
    <script>
        ...
        function createData(slabelCollect) {
            if (slabelCollect == "") {
                return;
            }
        ...
        editData();
        function editData(slabelCollect = {!! json_encode($query['id']) !!}) {            
            if (slabelCollect == "") {
                return;
            }
            ...
            console.log(slabelCollect);
            
            $.ajax({
                dataType: 'json',
                type: "GET",
                url: '{{ env('APP_URL') }}' + "/api/global/select-module/edit/" + slabelCollect,
