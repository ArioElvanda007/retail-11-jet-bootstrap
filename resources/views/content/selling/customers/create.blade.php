    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-solid">
                <form class="form" action="{{ route('selling.customers.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="p-2 card-footer d-print-none">
                        <div class="d-flex justify-content-end">
                            @if ($provider::access('customers')->access[0]->can_create == 1)
...
@section('page-script')
    <script>
        function backToList() {
            window.location.href = "{{ route('selling.customers.index') }}";
        }
    </script>
@endsection
