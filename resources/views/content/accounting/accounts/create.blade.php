    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-solid">
                <form class="form" action="{{ route('accounting.accounts.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <input type="text" class="form-control" id="code" name="code"
                                            placeholder="Account Code" value="" required autofocus/>
                                    </div>
                    ...
                    <div class="p-2 card-footer d-print-none">
                        <div class="d-flex justify-content-end">
                            @if ($provider::access('accounts')->access[0]->can_create == 1)
