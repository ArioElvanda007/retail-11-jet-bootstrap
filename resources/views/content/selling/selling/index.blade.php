        ...
        <div class="container-fluid">
            ...
            <div class="card card-solid">
                <div class="card-body">
                    ...
                    <form class="form mb-2" action="{{ route('selling.selling.index') }}" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2 d-flex align-items-end">
                                ...
                                @if ($provider::access('selling')->access[0]->can_create == 1)
                                ...
                                <tr>
                                    ...
                                    <td class="d-print-none">
                                        @if ($provider::access('selling')->access[0]->can_update == 1)
                                            <a href="{{ route('selling.selling.edit', $data->id) }}">
                                        ...
                                        @if ($provider::access('selling')->access[0]->can_delete == 1)
                                            <a onclick="return confirm('Are you sure?')"
                                                href="{{ route('selling.selling.destroy', $data->id) }}">
